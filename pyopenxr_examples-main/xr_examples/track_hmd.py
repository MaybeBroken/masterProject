...
with xr.InstanceObject(application_name="track_hmd") as instance, xr.SystemObject(
    instance
) as system, xr.GlfwWindow(system) as window, xr.SessionObject(
    system, graphics_binding=window.graphics_binding
) as session:
    for _ in range(50):
