...
class OpenXRProgram(object):
    ...
    def log_action_source_name(self, action: xr.Action, action_name: str):  # type: ignore
    ...
    def poll_events(self) -> (bool, bool):  # type: ignore
...
def xr_debug_callback(
    ...
    data: POINTER(xr.DebugUtilsMessengerCallbackDataEXT),  # type: ignore
    _user_data: c_void_p,
) -> bool:
    d = data.contents
