...
from api.graphics_plugin import IGraphicsPlugin
from api.platform_plugin import IPlatformPlugin
from api.openxr_program import OpenXRProgram
from api.graphics_plugin_opengl import OpenGLGraphicsPlugin
from api.platform_plugin_win32 import Win32PlatformPlugin
from api.platform_plugin_xlib import XlibPlatformPlugin
...
def initalize():
    ...
    while True:
        ...
        with create_graphics_plugin(options) as graphics_plugin, OpenXRProgram(
            options, platform_plugin, graphics_plugin
        ) as program:
