...
class OpenGLGraphicsPlugin(IGraphicsPlugin):
    ...
    def initialize_device(self, instance: xr.Instance, system_id: xr.SystemId): # type: ignore
    ...
    def render_view(
            ...
            swapchain_image_base_ptr: POINTER(xr.SwapchainImageBaseHeader), # type: ignore
